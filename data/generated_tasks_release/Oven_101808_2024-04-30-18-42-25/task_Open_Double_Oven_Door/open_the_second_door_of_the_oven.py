...
class open_the_second_door_of_the_oven(SimpleEnv):
    ...
    def _compute_reward(self):
        ...
        door_pos = get_link_state(self, "Oven", "link_1")
...
gym.register(
    id='gym-open_the_second_door_of_the_oven-v0',
    entry_point=open_the_second_door_of_the_oven,
)
